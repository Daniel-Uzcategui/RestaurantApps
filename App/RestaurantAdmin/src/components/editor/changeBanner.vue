<template>
  <div class="column items-center">
       ...
       <q-card-section>
         <p class="q-pt-md text-center text-h5">Imagen de banner para Menu</p>
         ...
         <q-item class="column items-center" key="photo">
            ...
            <div class=" column items-start" v-if="bannerimage === null">
            ...
            <div class="column items-start" v-else>
                <q-avatar rounded class="q-mb-sm shadow-5" size="180px" @click="photoUpload = true">
                    <q-img :src="bannerimage.desktopbanner"></q-img>
                </q-avatar></div>
                </div>
          </q-item>
       </q-card-section>
  ...
  mounted () {
    this.bindManifest().then(e => {
      ...
      if (typeof e !== 'undefined' && e !== null && typeof e.bannerimage !== 'undefined' && e.bannerimage !== null) {
        this.bannerimage = {}
        Vue.set(this.bannerimage, 'desktopbanner', typeof e.bannerimage && typeof e.bannerimage.desktopbanner !== 'undefined' ? e.bannerimage.desktopbanner : '')
        Vue.set(this.bannerimage, 'mobilebanner', typeof e.bannerimage && typeof e.bannerimage.mobilebanner !== 'undefined' ? e.bannerimage.mobilebanner : '')
      }
    })
  },
  computed: {
  ...
  methods: {
    ...
    uploadComplete (info) {
      try {
        this.bannerimage = {}
        for (let i of info) {
          this.bannerimage[i.file] = i.link
        }
