...
export const addUserToUsersCollection = async (state, userRef) => {
  ...
  const { email, nombre, apellido, cedula, id, sexo, fecnac } = state,
...
export const createUser = async function ({ dispatch, commit }, data) {
  ...
  return addUserToUsersCollection2({ email, nombre, apellido, cedula, id, sexo, fecnac, status, admin, typeAccess, codigo, razonSocial, RIF, razonComercial, rol, codigoDelivery, statusUbicacion, movilidad, statusdelivery, phone, DateIn }, userRef)
}
...
export const addUserToUsersCollection2 = async (state, userRef) => {
  ...
  const {
    ...
    user = new User({ email, nombre, apellido, cedula, id, sexo, fecnac, status, admin, typeAccess, codigo, razonSocial, RIF, razonComercial, rol, codigoDelivery, statusUbicacion, movilidad, statusdelivery, phone, DateIn })
