...
<div v-else>
  <q-item class="row justify-between">
              <q-item-section class="col">
                <q-btn v-if="!orders" color="primary" class="q-ma-md q-mr-lg" style="height: 25px; width: 25px;" size="xs" round @click="$emit('delcart')" icon="clear"></q-btn>
               </q-item-section>
               <q-item-section>
                 <div>
                   <q-item-label :class="$q.screen.lt.md ? 'text-caption' : ''">
...
export default {
  ...
  props: ['photo', 'name', 'priceDisplay', 'item', 'cart', 'discount', 'totalItComp', 'subTotalItem', 'extrasTotalItem', 'Total', 'orders', 'value']
}
</script>
