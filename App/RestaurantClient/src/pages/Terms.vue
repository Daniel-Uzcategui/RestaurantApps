  ...
  <q-card style="width: 700px; max-width: 80vw">
    ...
    <q-card-section>
      ...
      <p class="detail">
        ...
        Servicio”, “Términos”), incluidostodos los términos y condiciones
        adicionales y las políticas a las que se hace referencia en el presente
      ...
      <p class="detail">
        ...
        Términos de Servicio son considerados una oferta, la aceptación está
        expresamente limitada a estos Términos de Servicio. Cualquier función
        nueva o herramienta que se añadan a la tienda actual, tambiénestarán
        sujetas a los Términos de Servicio. Puedes revisar la versión
        actualizada de los Términos de Servicio, en cualquier momento en esta
        página. Nos reservamos el derecho de actualizar, cambiar o reemplazar
        cualquier parte de los Términos de Servicio mediante la publicación de
        ...
        continuo o el acceso al sitio web después de la publicación de cualquier
        cambio constituye la aceptación de dichos cambios. Nuestra tienda se
        encuentra alojada en FIREBASE HOSTING y administrada con la herramienta
        CHOPZI. Ellos nos proporcionan la plataforma de comercio electrónico en
        línea, que nos permite venderte nuestros productos y servicios.
      </p><p class="detail">
      Derechos reservados de
      <a href="http://www.pfcevolution.com">www.pfcevolution.com </a> y
      <a href="http://www.chopzi.com">www.chopzi.com</a></p>
      ...
      <p class="detail">
        ...
        permiso por escrito de parte de PFC Evolution S.A. Los títulos
        utilizados en este acuerdo se incluyen solo por conveniencia y no limita
        o afecta a estos Términos.
      </p>
      <div class="text-h6">
      ...
      <p class="detail">
        ...
        dirección de facturación ó número de teléfono proporcionado en el
      ...
      <p class="detail">
        Aceptas indemnizar, defender y mantener indemne a POKE212 u
        PFCEVOLUTIONy nuestras matrices, subsidiarias, aliados, socios,
      ...
      <p class="detail">
        ...
        de usar nuestro sitio. Sia nuestro juicio, fallas, o se sospecha que ha
        falladoen el cumplimiento de cualquier término o disposición de estas
        Condiciones de Servicio, también podemos terminar este acuerdo en
        cualquier momento sin previo aviso, y seguirás siendo responsable de
        todos los montos adeudados hasta la fecha, incluída la fecha de
        terminación; y/o en consecuencia podemos negarte el acceso a nuestros
