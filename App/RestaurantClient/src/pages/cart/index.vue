                  ...
                  <div
                     ...
                     <div class="col-6" style="min-width: 300px">
                      ...
                      <q-list class="q-pa-sm" v-if="config">
                        ...
                        <q-item v-if="getLocBySede('statusSeller') && currentUser && currentUser.typeAccess && currentUser.typeAccess.Seller">
...
export default {
  ...
  methods: {
    ...
    makeOrder (details) {
      ...
      let order = { productos: cartManage, photo: this.photoSRC, orderWhen, sede: this.getSede(), cart: this.cart, tipEnvio: this.tipEnvio, typePayment: this.pagoSel, customer, customer_id: this.currentUser.id, status: 0, table: 0, delivery: this.deliveryPrice, paid: (this.tipEnvio === '1' || this.tipEnvio === '4') ? (parseFloat(this.getTotalCarrito()[2]) + parseFloat(this.deliveryPrice)).toFixed(2) : parseFloat((parseFloat(this.getTotalCarrito()[2])).toFixed(2)) }
